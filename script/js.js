...
`,
    ...
    3: {
      ...
      answers: {
        ...
        2: `🚀উইকেট ৭১ এ আপনি নগদে মিনিমাম ১০০ আর বিকাশ, রকেটে মিনিমাম ২০০ টাকা  করতে পারেন।<br><br> কখনো আমাদদের নাম্বার গুলো সেভ করবেন না, আমাদের নাম্বার পরিবর্তন হয়। আমাদের এখানে ক্যাশ আউট করবেন সবসময়।<br><br>  ভিডিও দেখতে: <a href="https://wicket71.info/" target="_blank">এখানে ক্লিক করুন</a> `,
    ...
    6: {
      ...
      options: {
        ...
        2: "App ডাউনলোডে ফ্রি ৳100 টাকা বোনাস সম্পর্কে জানতে চাই ",
      ...
      answers: {
        ...
        2: 'আপনি আমাদের অ্যাপ ডাউনলোড করে লগইন করলে ১০০ টাকা ফ্রি পাবেন। আপনার নাম্বার ভেরিফিকেশন কমপ্লিট করুন এবং হোয়াটসঅ্যাপ নাম্বারটি অ্যাড করুন।  এ দুটো স্টেপ কমপ্লিট করলে তাহলে আপনি পেয়ে যাবেন অ্যাপ ডাউনলোড ফ্রি বোনাস । মনে রাখবেন আপনি এই বোনাস টা একবার নিতে পারবেন , আর মিনিমাম একবার ডিপোজিট থাকা লাগবে আপনার, ধন্যবাদ।<br><br>অ্যাপ লিংক: <a href="https://www.wicket71bd.com/" target="_blank">https://www.wicket71bd.com/</a><br><br>------------------------------------<br><br>🔰 আপনি অ্যাপ ডাউনলোড করেছেন তারপরে মোবাইল নাম্বার ভেরিফাই করেছেন এবং ৩/৪ ঘন্টা পার হয়ে গেছে - এসব গুলো করার পরেও আপনি যদি বোনাস না পান তবে আপনি আর বোনাস পাবেন না । তার অনেকগুলি কারণ থাকতে পারে। যেমন :<br>১) আপনি ইতিমধ্যে অন্য একটা একাউন্ট দিয়ে বোনাসটি নিয়েছেন, তাহলে আর ওই বোনাস নিতে পারবেন না কারণ প্রত্যেকে একবার করে এই বোনাস টি নিতে পারে<br>২) আপনি আপনার মোবাইল নাম্বারটি হয়তো এখনো ভেরিফাই করেননি<br>৩) আপনি অ্যাপের ভেতরে লগইন করেননি<br>৪) আপনার আইপিতে কোনরকম সমস্যা আছে<br>৫) আপনি কোনো ডিপোজিট এখনো করেননি<br><br>এই সমস্ত বিভিন্ন কারণে আপনার একাউন্টে ১০০ টাকা বোনাস অ্যাড নাও হতে পারে তবে সবকিছু ঠিকঠাক থাকলে আপনি অবশ্যই পাবেন ধন্যবাদ। যদি ৩/৪ ঘন্টা পার হয়ে যাই তাও না পান তবে আপনি পাবেন না। আমাদের অন্য বোনাস নিয়ে খেলুন।<br>',

        3: '🚀 %customer-name% স্যার, প্রতিদিন আপনি ফ্রি ৩০০ টাকা পর্যন্ত বোনাসটির মেয়াদ শেষ হয়ে গেছে <br><br>📍 আরো জানতে: <a href="https://www.wicket71bd.com/promotions" target="_blank">https://www.wicket71bd.com/promotions</a><br><br>  কিভাবে বোনাস নিতে হয় ভিডিও দেখতে: <a href="https://wicket71.info/" target="_blank">এখানে ক্লিক করুন</a>',
        ...
        5: '🚀 %customer-name% স্যার, আপনি যদি আমাদের নতুন সদস্য হন, তবে প্রথম ডিপোজিটে ১০০ শতাংশ, তারপরের ডিপোজিটে ৫০ শতাংশ এবং তারপরে ডিপোজিটে ২১ শতাংশ বোনাস অর্থাৎ মোট ১৭১ শতাংশ বোনাস নিতে পারবেন।<br><br>🔊 এই বোনাস নিতে কমপক্ষে ৫০০ টাকার ডিপোজিট করতে হবে এবং এই বোনাসের টার্নওভার প্রথমে ২০x, তারপর ১৫x এবং শেষে ১০x হবে। স্যার, আপনাকে বোনাস নেওয়ার জন্য ফোন নাম্বার ভেরিফাই এবং আপনার ব্যাংক একাউন্ট যুক্ত থাকা লাগবে অবশ্যই।<br><br>📍 আরো জানতে: <a href="https://www.wicket71bd.com/promotions" target="_blank">https://www.wicket71bd.com/promotions</a><br><br> কিভাবে বোনাস নিতে হয় ভিডিও দেখতে: <a href="https://wicket71.info/" target="_blank">এখানে ক্লিক করুন</a>',

        6: '🚀 প্রথমে আপনার প্রোফাইলে যাবেন এবং সেখানে "রেফারাল কোড" নামে একটি অপশন দেখতে পাবেন। সেখানে থেকে আপনার রেফার লিঙ্ক কপি করে আপনার বন্ধুদের সাথে শেয়ার করুন। যতজন ওই লিঙ্ক দিয়ে একাউন্ট খুলবে, ততজনের থেকে আপনি রেফার বোনাস পাবেন।<br><br>প্রিয় Wicket71 সদস্য, Wicket71- এ রেফার করা শর্তাবলী নিচে লিখে দেওয়া হলো<br>◻️ Wicket71-এ বন্ধুকে রেফার করে আপনি ৫০০ টাকা এবং ৫ টি করে লয়ালিটি পয়েন্ট পাবেন। যখন আপনার বন্ধু ২০০০ ডিপোজিট আর ১২০০০ টার্নওভার করবেন।<br>◻️ আপনি যাকে রেফার করবেন তার থেকে ০.১০% কমিশন পাবেন।<br>◻️ যাকে রেফার করেছেন সে কাওকে রেফার করলে তার থেকে ০.২৫% কমিশন পাবেন।<br>◻️ আবার সেও যদি কাওকে রেফার করে তবে তার থেকে ০.৫০% কমিশন পাবেন।<br>◻️ যাকে রেফার করেছেন সে যখনি টার্নওভার করবে তার ১ ঘন্টা পর আপনার একাউন্ট এ কমিশন অ্যাড হবে।<br>◻️ রেফার বোনাস এর জন্যে ৮X টার্ন ওভার পূরণ করতে হয় তবে আপনি যা কমিশন পাবেন সেটার মাত্র ১X টার্নওভার।<br>  কিভাবে রেফার করবেন ভিডিও দেখতে: <a href="https://wicket71.info/" target="_blank">এখানে ক্লিক করুন</a>',
    ...
    9: {
      ...
      options: {
        ...
        6: "আমি ১০০ টাকার নিচে ডিপোজিট করে ফেলেছি এখন কি করতে পারি?",
        ...
        14: "ক্যাশ ভাওচার মেসেজ এসেছে আমার",
        main: "Main Menu",
      },
      answers: {
        1: "আমাদের অফিস ঢাকা গুলশান ২ তে অবস্থিত।",

        2: 'আমাদের এখানে বিভিন্ন পেমেন্ট গেটওয়ে আছে , আপনি যে পেমেন্ট গেটওয়ে ব্যবহার করে ডিপোজিট করবেন সেখান থেকে দেখতে পারবেন ক্যাশআউট না সেন্ড মানি করতে হবে । তবে সাধারনত আমাদের এখানে ক্যাশ আউট করতে হয়। নগদে মিনিমাম ১০০ আর বিকাশ, রকেটে মিনিমাম ২০০ টাকা ডিপোজিট করতে পারবেন আমাদের এখানে।<br><br>  কিভাবে ডিপোজিট করবেন ভিডিও দেখতে: <a href="https://wicket71.info/" target="_blank">এখানে ক্লিক করুন</a>',
        ...
        6: 'যেহেতু আমাদের এখানে নিয়ম কমপক্ষে ১০০ টাকার ডিপোজিট করতে হবে কিন্তু আপনি ১০০ টাকার কম ডিপোজিট করে ফেলেছেন। এক্ষেত্রে আমাদের কিছুই করার নেই , অনুগ্রহ করে আপনি আবার ডিপোজিট করুন স্যার ১০০ টাকার উপরে আর আমাদের খেলা উপভোগ করুন <br><br>ডিপোজিট ভিডিও দেখতে: <a href="https://wicket71.info/" target="_blank">এখানে ক্লিক করুন</a>',
        ...
        14: 'আপনিও পেতে পারেন IMILAB Smart Watch এটা সবার জন্যে উপলব্ধ। পর পর ৬০ দিন একটানা খেলা করুন Wicket71 এ আর পেয়ে যান আকর্ষনীয়  সব পুরস্কারগুলি।<br><br>🎁 প্রথম দিন পাবেন ৫৮ টাকা ফ্রি বোনাস ।<br><br>🎁 ২য় - ৯ম দিনে প্রতিদিন ২ টি করে লয়ালিটি পয়েন্ট ।<br><br>🎁 ১০ম দিনে ১০০ টাকার ক্যাশ ভাওচার।<br><br>🎁 ১১ম - ১৯ম  দিনে প্রতিদিন ২ টি করে লয়ালিটি পয়েন্ট ।<br><br>🎁 ২০ম দিনে ৩৮৮ টাকার ক্যাশ ভাওচার।<br><br>🎁 ২১ম দিনে ১৮৮ টাকার ক্যাশ ভাওচার।<br><br>🎁 ২২তম - ২৯তম দিনে প্রতিদিন ২ টি করে লয়ালিটি পয়েন্ট ।<br><br>🎁 ৩০ম দিনে ১০০ টাকার ক্যাশ ভাওচার।<br><br>🎁 ৩১তম - ৩৯ দিনে প্রতিদিন ২ টি করে লয়ালিটি পয়েন্ট ।<br><br>🎁 ৪০ম দিনে ৪৮৮ টাকার ক্যাশ ভাওচার।<br><br>🎁 ৪১তম - ৪৯তম দিনে প্রতিদিন ২ টি করে লয়ালিটি পয়েন্ট ।<br><br>🎁 ৫০ম দিনে ১০০ টাকার ক্যাশ ভাওচার।<br><br>🎁 ৫১তম - ৫৯তম দিনে প্রতিদিন ২ টি করে লয়ালিটি পয়েন্ট ।<br><br>🎁 ৬০ম দিনে 100% পাবেন  IMILAB W13 smart Watch.<br><br><br><br>✔ আপনি প্রতিদিন কিছু না কিছু পাবেন যদি প্রতিদিন সাইন ইন করে ১২৫০ ডিপোজিট ও ৫০০০ টার্নওভার পূরণ করেন। আপনি যদি টার্গেট পূরণের ভিতর গ্যাপ দেন তবে আপনার টার্গেট আবার প্রথম থেকে শুরু হবে।<br><br><br><br>✔ লয়ালিটি পয়েন্ট দিয়ে আপনারা পয়েন্ট মল থেকে কেনাকাটা করতে পারবেন যেমন : টিভি , ফ্রিজ , এসি , মোবাইল , ঘড়ি, গেমের ভিতর টাকা ইত্যাদি।',
        main: "Main Menu",
      },
    },
  };
