...
ভিডিও দেখুন কিভাবে একাউন্ট খুলবেন: <a href="https://wicket71.info/#register" target="_blank">এখানে ক্লিক করুন</a> <br><br>
`,
    ...
    4: {
      ...
      answers: {
        2: '🚀 স্যার, কিভাবে উইকেট ৭১ এ উত্তোলন (Withdraw) করবেন, নিচের এই লিঙ্কে ক্লিক করে খুব সহজেই শিখে নিতে পারেন।<br><br>📍 <a href="https://wicket71.info/#withdraw" target="_blank">এখানে ক্লিক করুন</a><br><br>◻️ উত্তোলন (Withdraw) করতে কোন রকম সমস্যা হলে, অবশ্যই আমাদের সাথে যোগাযোগ করবেন।<br><br>🎳 স্যার, আমি কি আর অন্য কোন তথ্য দিয়ে সহায়তা করতে পারি আপনাকে?<br><br> ',
    ...
    9: {
      ...
      answers: {
        ...
        2: 'না স্যার , আমাদের এখানে শুধু ক্যাশ আউট করতে পারবেন। <br><br> দেখুন কিভাবে ডিপোজিট করবেন : <a href="https://wicket71.info/#deposit" target="_blank">এখানে ক্লিক করুন </a>',
        ...
        4: 'বোনাস নিতে গেলে আপনাকে অবশ্যই ডিপোজিট করতে হবে এবং তারপরে ডিপোজিট এর ওখানেই দেখতে পাবেন বিভিন্য ধরনের বোনাস আছে , আপনি যে বোনাস টি নিতে চান সেটা সিলেক্ট করে নেবেন আর তারপর সাবমিট করে এগিয়ে যাবেন।<br><br>দেখুন কিভাবে বোনাস নিতে হয় : <a href="https://wicket71.info/#deposit" target="_blank">এখানে ক্লিক করুন </a>',
        ...
        7: `🚀 প্রথমে আপনার প্রোফাইলে যাবেন এবং সেখানে "রেফারাল কোড" নামে একটি অপশন দেখতে পাবেন। সেখানে থেকে আপনার রেফার লিঙ্ক কপি করে আপনার বন্ধুদের সাথে শেয়ার করুন। যতজন ওই লিঙ্ক দিয়ে একাউন্ট খুলবে, ততজনের থেকে আপনি রেফার বোনাস পাবেন।<br><br>Wicket71-এ রেফার করার শর্তাবলী:<br>◻️ Wicket71-এ রেফারেল বোনাস সমস্ত সদস্য নিতে পারবেন।<br>◻️ আপনার রেফারেল লিঙ্কের মাধ্যমে আপনার বন্ধুকে আমন্ত্রণ জানাবেন।<br>◻️ বন্ধুকে রেফার করলে, তাকে মিনিমাম ২০০০ টাকা ডিপোজিট ও ১২,০০০ টাকা টার্নওভার করতে হবে। তখন আপনি ৫০০ টাকা বোনাস পেয়ে যাবেন অটো।<br>◻️ প্রতি রেফারে আপনি ৫০০ টাকা এবং ৫ টি করে লয়ালিটি পয়েন্ট পাবেন, যাকে রেফার করবেন সে যখন ডিপোজিট ও টার্নওভার পূরণ করবেন।<br>◻️ ক্লেমের কোন লিমিট নেই, আপনি যত ইচ্ছা রেফার করতে পারবেন এবং প্রতিবার রেফার তার শর্ত পূরণ করলে আপনি বোনাস পেয়ে যাবেন।<br>◻️ রেফার বোনাসের জন্য ৮x টার্নওভার পূরণ করতে হয়।<br><br>আরো জানতে: <a href="https://t.ly/47nJi" target="_blank">https://t.ly/47nJi</a><br><br>দেখুন কিভাবে রেফার করতে হয় : <a href="https://wicket71.info/#refer" target="_blank">এখানে ক্লিক করুন </a>`,
